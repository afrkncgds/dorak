...
class HeaderComponent extends Component {
    ...
    render() {
        ...
        return (
            <div className={`header-root ${this.state.isScroll ? " sticky" : ""} `} >

                <div className="header-wrapper">

                    <div className="header-top-wrapper text-area">
                        <div className="logo-container ">
                            
                            <div className="mobil-header-open-item" onClick={this.props.openMobileMenu}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="25px" height="25px" viewBox="0 0 448 512"><path fill="#ffffff" d="M0 96C0 78.3 14.3 64 32 64H416c17.7 0 32 14.3 32 32s-14.3 32-32 32H32C14.3 128 0 113.7 0 96zM0 256c0-17.7 14.3-32 32-32H416c17.7 0 32 14.3 32 32s-14.3 32-32 32H32c-17.7 0-32-14.3-32-32zM448 416c0 17.7-14.3 32-32 32H32c-17.7 0-32-14.3-32-32s14.3-32 32-32H416c17.7 0 32 14.3 32 32z"/></svg>
                            ...
                            <a href="/" className="logo-item">
                                <picture>
                                    ...
                                    <img src={`${ASSETS}/logo/dorak logo.png`} alt="logo" />
                                </picture>
                            </a>
                    ...
                    <div className="header-bottom-wrapper text-area">
                                                        ...
                                                        <div className="collapse navbar-collapse clearfix" id="navbarSupportedContent">
                                                            <ul className="navigation clearfix">
                                                                ...
                                                                <li className="dropdown">
                                                                    ...
                                                                    <ul>
                                                                        <li className="dropdown">
                                                                            ...
                                                                            <ul>
                                                                                <li><a href="/hair">Hair Transplantation</a></li>
                                                                                <li className="dropdown">
                                                                                    <a href="/body">Body </a>
                                                                                    <ul>
                                                                        ...
                                                                        <li><a href="/inVitro">In Vitro Fertilization (IVF) Andrology And Genetics Center</a></li>
                                                                        <li><a href="/dentistry">Dentistry</a></li>
                                                                        <li className="dropdown">
                                                                            <a href="/eyeSurgery">Eye Surgery </a>
                                                                            <ul>
                                                                        ...
                                                                        <li><a href="/dentalOralHealth">Dental & Oral Health</a></li>
                                                                        <li><a href="/obesity">Obesity Surgery</a></li>
                                                                        <li className="dropdown">
                                                                ...
                                                                <li className="dropdown">
                                                                    ...
                                                                    <ul>
                                                                        <li ><a href="/ourStep">Our Responsibilities</a></li>
                                                                        <li><a href="/fourStep">Four Steps To Discover Turkey</a></li>
                                                                    </ul>
                                                                </li>
                                                                <li className="dropdown">
                                                                    <a href="/tours">Tours </a>
                                                                    <ul>
                                                                        <li><a href="/sevenDay">7-Day Tour</a></li>
                                                                        <li><a href="/capadociaIstanbul">Cappadocia – Istanbul Tour</a></li>
                                                                        <li><a href="/capadocia">Cappadocia Tour</a></li>
                                                                        <li><a href="/istanbul">Istanbul Tour</a></li>
                                                                    </ul>
                                                                </li>
                                                                <li>
